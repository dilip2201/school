         ...
         <fieldset>
            ...
            <form  action="{{ route('admin.uniform.storeitem') }}"  enctype="multipart/form-data" autocomplete="off" method="post" class="form-horizontal form-bordered formsubmit">
               ...
               <div class="col-md-6" style="float: right;">
                  <div class="form-group">
                     <button type="submit" class="btn btn-primary  submitbutton pull-right submititem"> Submit <span class="spinneritem"></span></button>
                  </div>
               </div>
            </form>
         ...
         <table style="width:100%" class="itemdatatable">
           ...
           <tbody>
            ...
            @foreach ($item_masters as $item_master)
             ...
             <td><img src="{{$image}}" class="image_preview1 profile-user-img" style="border: 1px solid #adb5bd; width: 60px; height: 48px;"></td>
